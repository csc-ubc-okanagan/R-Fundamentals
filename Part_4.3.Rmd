...
Encoding of new line characters has some interesting spill over effects from the era of mechanical typing. While your Unix and Linux based operating systems--including Mac OS--simply encode a new line with `\n` denoting \"line feed\", Windows base machines encode it as `\r\n', denoting \"carriage return, line feed"\ which more closely resemble a type writer where you have to not only move down a line, but also shift the carriage back to the left margin.
</div>
